    ...
    <>
      ...
      <div className="min-h-screen bg-background text-foreground relative overflow-hidden">
        ...
        <main className="relative z-10">
          {/* Header */}
          <section className="relative pt-16 md:pt-20 pb-12 md:pb-16 px-4 md:px-8 overflow-hidden text-center">
            <ParticleEffects count={12} color="gold" intensity="subtle" />
            <div className="relative max-w-4xl mx-auto">
              <h1 className="text-4xl md:text-5xl font-decorative text-gold mb-4 leading-tight">
                Fractured Paths
              </h1>
              <p className="text-lg text-muted-foreground">
                Choose your path through fractured realities
              </p>
            </div>
          </section>
